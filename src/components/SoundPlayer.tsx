  ...
  return (
    <div className="mt-4 rounded-2xl border border-asphalt-700 bg-asphalt-900 p-4">
      ...
      {hasSrc ? (
        <>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-tacho px-4 py-3.5 text-sm font-bold text-white transition hover:brightness-110"
          >
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-titanium-500">
        スマホのマナーモードでは音が出ないことがあります。音源はストリーミング再生（preload=none）です。
      </p>
    </div>
  );
}
